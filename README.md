...
=============================
This project provides software to support create a more PC-like experience for Raspberry Pi 4 (RPi4) I call Pi Desktop eXperience or pdx.  It uses the Geekworm X735 for power control and X856 for mSATA storage but I reserve the right to change that over time.  I have ordered a X872 which is a NVMe storage solution for RPi4 and will update this once I get a chance to test it out. This repository contains information on how to best use the X856 and a completely new approach to X735 for power management. The hardware is available at http://geekworm.com sourced from SupTronics. 
